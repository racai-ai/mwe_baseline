 ...
 */
public class MWECUPT2CSV {
	
	public static void help() {
		System.out.println("MWECUPT2CSV MWE_CUPT CSV");
		System.exit(-1);
	}
    ...
    public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException, InterruptedException {
    	...
    	System.out.println(String.format("CUPT=%s\nCSV=%s\n",
    			conllup,csv
    	));
    	    	
    	System.out.println("Reading MWE CUPT file and computing stats");
    	...
    	Thread t=new MWECUPTProcessor(conllup, tmxBufferRead);
    	t.start();
    	threads.add(t);
